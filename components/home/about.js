    ...
    return (
        <div className="container py-12 relative">
            <div className="flex flex-col gap-8 relative">
                ...
                <p className="max-w-xl text-sm sm:text-base">Adipisicing sit fugit ullam unde aliquid sequi Facilis soluta facilis
        ...
        <div className="w-96 h-96">
            ...
            >
                ...
                <defs>
                    ...
                    >
                        <stop offset="0.333333" stopColor={theme === 'dark' ? '#FBFBFB' : '#040404'}/>
